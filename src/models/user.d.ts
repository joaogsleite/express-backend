...
declare class User extends Model {
  ...
  public setRoles!: BelongsToManySetAssociationsMixin<
    Role,
    Role["id"],
    "Roletag"
  >;
  public addRole!: BelongsToManyAddAssociationMixin<
    Role,
    Role["id"],
    "Roletag"
  >;
  public addRoles!: BelongsToManyAddAssociationsMixin<
    Role,
    Role["id"],
    "Roletag"
  >;
  public createRole!: BelongsToManyCreateAssociationMixin<
    Role,
    Role["id"],
    "Roletag"
  >;
