...
declare class Role extends Model {
  ...
  public setUsers!: BelongsToManySetAssociationsMixin<User, User['id'], 'Usertag'>;
  public addUser!: BelongsToManyAddAssociationMixin<User, User['id'], 'Usertag'>;
  public addUsers!: BelongsToManyAddAssociationsMixin<User, User['id'], 'Usertag'>;
  public createUser!: BelongsToManyCreateAssociationMixin<User, User['id'], 'Usertag'>;
